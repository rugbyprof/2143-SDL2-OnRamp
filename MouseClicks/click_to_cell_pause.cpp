// =============================================================
// click_to_cell_pause.cpp - SDL2 Clickable Grid with Pause Toggle
// =============================================================
// g++ click_to_cell_pause.cpp -o clickpause -I/opt/homebrew/include/SDL2 -I/opt/homebrew/include/SDL2_ttf -L/opt/homebrew/lib -lSDL2 -lSDL2_ttf
// =============================================================
...
int main() {
    ...
    SDL_Window*   window = SDL_CreateWindow("Grid with Pause Toggle",
    ...
    while (running) {
        ...
        SDL_Surface* surf = TTF_RenderText_Solid(font, oss.str().c_str(), white);
